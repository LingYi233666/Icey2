PrefabFiles = {
    ...
    "icey2_blue_arrow_projectile",
    "icey2_test_shooter",
    "icey2_dodge_charge_chip",
    "icey2_skull_projectile",
    "icey2_skull_tail_vfx",
    "icey2_pact_weapon_gunlance_openfire_vfx",

    "icey2_pact_weapon_chainsaw",
    "icey2_pact_weapon_chainsaw_projectile",

    "icey2_chainsaw_hit_fx",
...
TUNING.ICEY2_PARRY_DIRECTION = GetModConfigData("parry_direction")

...
function Icey2WeaponSkill.AddAoetargetingClient(inst, aoetype, tags, range, extrafn)
    range = range or 8
...
function Icey2WeaponSkill.AddAoetargetingServer(inst, spellfn, ondischarged, oncharged, extrafn)
...
GLOBAL.Icey2WeaponSkill = Icey2WeaponSkill

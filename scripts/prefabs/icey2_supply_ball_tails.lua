...
local COLOUR_ENVELOPE_NAME_TAIL_BLUE = "icey2_supply_ball_tail_blue_colourenvelope"
local COLOUR_ENVELOPE_NAME_TAIL_RED = "icey2_supply_ball_tail_red_colourenvelope"
